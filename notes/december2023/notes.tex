...
\begin{figure*}[t!]
   ...
   \caption{\label{fig:ordparam_noflow} Left: Order parameters $\Pi$ and $\Psi$ as a function of $g$ for $v_1=15$. Center: Mass profile $N_j$ as a function of the distance to the wall $1-y/h = 2j/(N_y-1)$; The dashed line shows a uniform distribution. Right: Order parameter $\Phi$ as a function of the distance to the wall.}
   \vspace{10pt}
   \hspace{-10pt}
