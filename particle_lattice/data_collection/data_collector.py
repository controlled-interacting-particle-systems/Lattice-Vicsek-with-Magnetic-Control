...
class DataCollector:
    ...
    def __init__(self):
        ...
        self.data = pd.DataFrame(
            columns=["TimeStep", "ElapsedTime", "OrientationCounts", "LatticeState"]
        )
    ...
    def _orientation_vector_from_counts(self, counts):
        ...
        orientation_vectors = [
            ORIENTATION_TO_VECTOR[orientation] * count
    ...
    def analyze_data(self):
        ...
        orientation_vectors = self.data["OrientationCounts"].apply(
            self._orientation_vector_from_counts
        )
        ...
        self.data["CumulativeMeanOrderParameter"] = (
            self.data["OrderParameter"].expanding().mean()
        )
