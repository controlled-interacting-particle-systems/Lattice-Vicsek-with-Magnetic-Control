...
def test_compute_tm():
    ...
    zero_positions = [(0,4), (1,0), (1,1), (1,2), (1,3), (1,4), (2,0), (2,1), (2,3), (2,4), (3,0), (3,1), (3,2), (3,4), (4,0), (4,1), (4,2), (4,3), (4,4)]
...
def test_get_target_position():
    ...
    # 2. Down
    assert lattice.get_target_position(x, y, lattice.layer_indices["down"]) == (x, y + 1)
    # 3. Left
    assert lattice.get_target_position(x, y, lattice.layer_indices["left"]) == (x - 1, y)
    # 4. Right
    assert lattice.get_target_position(x, y, lattice.layer_indices["right"]) == (x + 1, y)
